...
def composite_identity(f, g):
    ...
    """
    "*** YOUR CODE HERE ***"
    a=lambda x: f(g(x))                                #a and b are both function names
    b=lambda x: g(f(x))
...
def cycle(f1, f2, f3):
    ...
    """
    "*** YOUR CODE HERE ***"
    # def apply_function(n):                              #Determine how many functions to apply based on n
    #     def apply(x):                                   #Calculate x
    #         resoult=x
    #         for i in range(n):
    #             if i%3 == 0:
    #                 resoult=f1(resoult)
    ...
    #Use recursion to implement fron openAI
